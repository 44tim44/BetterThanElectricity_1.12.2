...
public class BlockQuarry extends BlockContainerBase {
    ...
    public BlockQuarry(boolean isActive, String name) {
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        if (!world.isRemote)
        {
            ...
            if (player.isSneaking()) {
                ...
                player.openGui(BTEMod.instance, ModGuiHandler.QUARRY, world, pos.getX(), pos.getY(), pos.getZ());
            }
        }
        return true;
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModBlocks.quarry_on.getDefaultState()
        ...
        {
            worldIn.setBlockState(pos, ModBlocks.quarry.getDefaultState()
                    .withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.quarry.getDefaultState()
                    .withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public Class<TileEntityQuarry> getTileEntityClass() {
        return TileEntityQuarry.class;
    }

    /**
     * Returns a new instance of a block's tile entity class. Called on placing the block.
     */
    public TileEntityQuarry createNewTileEntity(World world, int meta)
    {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityQuarry)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityQuarry)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityQuarry)tileentity);
    ...
    {
        return new ItemStack(ModBlocks.quarry);
    }
