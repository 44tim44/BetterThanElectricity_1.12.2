 ...
 */
public class BlockDoorBase extends BlockBase
{
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        ...
        if(this == ModBlocks.glassDoor) {
            switch (enumfacing) {
                case EAST:
                default:
                    return flag ? EAST_AABB_GLASS : (flag1 ? NORTH_AABB : SOUTH_AABB);
                case SOUTH:
                    return flag ? SOUTH_AABB_GLASS : (flag1 ? EAST_AABB : WEST_AABB);
                case WEST:
                    return flag ? WEST_AABB_GLASS : (flag1 ? SOUTH_AABB : NORTH_AABB);
                case NORTH:
                    return flag ? NORTH_AABB_GLASS : (flag1 ? WEST_AABB : EAST_AABB);
            }
        } else{
            switch (enumfacing) {
                case EAST:
            ...
            else
            {
                ...
                if (blockIn != this && (flag || blockIn.getDefaultState().canProvidePower()) && flag != ((Boolean)iblockstate1.getValue(POWERED)).booleanValue())
                {
                    ...
                    if (flag != ((Boolean)state.getValue(OPEN)).booleanValue())
                    {
                        ...
                        if(state.getBlock()==ModBlocks.glassDoor)
                        {
                            worldIn.playSound((EntityPlayer) null, pos, ModSoundEvents.DOOR_SLIDE, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                        else
                        {
