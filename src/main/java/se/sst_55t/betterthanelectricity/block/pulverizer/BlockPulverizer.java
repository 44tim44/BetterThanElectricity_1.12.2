...
public class BlockPulverizer extends BlockContainerBase {
    ...
    public BlockPulverizer(boolean isActive, String name) {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModBlocks.pulverizer_on.getDefaultState()
        ...
        {
            worldIn.setBlockState(pos, ModBlocks.pulverizer.getDefaultState()
                    .withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.pulverizer.getDefaultState()
                    .withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityPulverizer)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
