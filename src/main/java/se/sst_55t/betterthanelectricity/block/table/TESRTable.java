 ...
 * @author shadowfacts
 */
public class TESRTable extends TileEntitySpecialRenderer<TileEntityTable> {
    ...
    public void render(TileEntityTable te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (!stack.isEmpty()) {
            ...
            double offset = Math.sin((te.getWorld().getTotalWorldTime() - te.lastChangeTime + partialTicks) / 8) / 12.0;
