 ...
 */
public class BlockCompactor extends BlockContainerBase {

    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private final boolean isActive;
    private static boolean keepInventory;

    public BlockCompactor(boolean isActive, String name) {
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        if (!world.isRemote)
        {
            ...
            if (player.isSneaking()) {
                ...
                player.openGui(BTEMod.instance, ModGuiHandler.COMPACTOR, world, pos.getX(), pos.getY(), pos.getZ());
            }
        }
        return true;
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModBlocks.compactor_on.getDefaultState()
        ...
        {
            worldIn.setBlockState(pos, ModBlocks.compactor.getDefaultState()
                    .withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.compactor.getDefaultState()
                    .withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public Class<TileEntityCompactor> getTileEntityClass() {
        return TileEntityCompactor.class;
    }

    /**
     * Returns a new instance of a block's tile entity class. Called on placing the block.
     */
    public TileEntityCompactor createNewTileEntity(World world, int meta)
    {
    ...
    {
        return new ItemStack(ModBlocks.pulverizer);
    }
