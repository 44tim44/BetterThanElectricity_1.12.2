...
public class BlockPaneBase extends BlockPane {
    ...
    public BlockPaneBase(Material material, String name, boolean canDrop) {
    ...
    @Override
    public BlockPaneBase setCreativeTab(CreativeTabs tab) {
     ...
     */
    @Override
    public BlockPaneBase setHardness(float hardness)
    {
