...
public class ModelSubmarine extends ModelBase implements IMultipassModel {
    ...
    public ModelRenderer[] glassSides = new ModelRenderer[5];
    ...
    public ModelSubmarine() {
        ...
        this.glassSides[0] = (new ModelRenderer(this, 0, 43)).setTextureSize(128, 64);
        this.glassSides[1] = (new ModelRenderer(this, 0, 43)).setTextureSize(128, 64);
        this.glassSides[2] = (new ModelRenderer(this, 0, 43)).setTextureSize(128, 64);
        this.glassSides[3] = (new ModelRenderer(this, 0, 43)).setTextureSize(128, 64);
        this.glassSides[4] = (new ModelRenderer(this, 0, 43)).setTextureSize(128, 64);
        int i = 32;
        int j = 6;
        int k = 20;
        int l = 4;
        ...
        this.glassSides[0].setRotationPoint(0.0F, -18.0F, 1.0F);
        this.glassSides[1].addBox(-12.0F, -7.0F, -1.0F, 16, 12, 2, 0.0F);
        this.glassSides[1].setRotationPoint(-15.0F, 18.0F, 4.0F);
        this.glassSides[2].addBox(-8.0F, -7.0F, -1.0F, 16, 12, 2, 0.0F);
        this.glassSides[2].setRotationPoint(15.0F, -8.0F, 0.0F);
        this.glassSides[3].addBox(-14.0F, -7.0F, -1.0F, 28, 12, 2, 0.0F);
        this.glassSides[3].setRotationPoint(0.0F, -8.0F, -9.0F);
        this.glassSides[4].addBox(-14.0F, -7.0F, -1.0F, 28, 12, 2, 0.0F);
        this.glassSides[4].setRotationPoint(0.0F, -8.0F, 9.0F);
        ...
        this.noWater.addBox(-14.0F, -9.0F, -3.0F, 28, 16, 15, 0.0F);
    ...
    protected void renderPaddle(EntitySubmarine boat, int paddle, float scale, float limbSwing) {
